      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        ...
        >
          ...
          >
            ...
            <br className="hidden md:block" />
            <span className="text-gradient-gold">Jewellers & Luxury Brands</span>
          </motion.h1>
          ...
          >
            Transform your jewelry business with stunning websites that captivate customers and drive sales. Trusted by luxury brands across India.
          </motion.p>
          ...
          >
            ...
            <Button variant="hero-outline" size="xl" asChild>
              <a href="tel:+918888266360" className="group">
          ...
          >
            <p className="text-sm text-muted-foreground mb-4">Trusted by premium businesses</p>
            <div className="flex items-center justify-center gap-8 text-muted-foreground/50">
              <span className="font-display text-lg">Jewellers</span>
              <span className="w-1 h-1 bg-primary/50 rounded-full" />
              <span className="font-display text-lg">Luxury Brands</span>
              <span className="w-1 h-1 bg-primary/50 rounded-full" />
              <span className="font-display text-lg">High-Value Businesses</span>
            </div>
          </motion.div>
        </motion.div>
      </div>
